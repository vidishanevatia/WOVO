...
public class LoadingView extends View {
    ...
    private int mIndicatorColor1,mIndicatorColor2,mIndicatorColor3;
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor1=a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor1, getResources().getColor(R.color.Tertiary));
        mIndicatorColor2=a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor2,getResources().getColor(R.color.Secondary) );
        mIndicatorColor3=a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor3,getResources().getColor(R.color.Primary));
    ...
    public void setIndicator(Indicator d) {
        if (mIndicator != d) {
            ...
            setIndicatorColor1(mIndicatorColor1);
            setIndicatorColor2(mIndicatorColor2);
            setIndicatorColor3(mIndicatorColor3);
            if (d != null) {
                d.setCallback(this);
            }
     ...
     * @param color
     */
    public void setIndicatorColor1(int color){
        this.mIndicatorColor1=color;
        mIndicator.setColor(color);
    }

    public void setIndicatorColor2(int color){
        this.mIndicatorColor2=color;
        mIndicator.setColor(color);
    }

    public void setIndicatorColor3(int color){
        this.mIndicatorColor3=color;
        mIndicator.setColor(color);
    }
